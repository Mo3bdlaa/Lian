...
export const ROUTES: readonly Route[] = [
  ...
  { pattern: '/assistants', screen: 'assistants' },
  { pattern: '/subscription', screen: 'subscription' },
  { pattern: '/settings/identity', screen: 'identity' },
  { pattern: '/settings/personality', screen: 'personality' },
  { pattern: '/settings/quiet-hours', screen: 'quietHours' },
  ...
  { pattern: '/confirm-email', screen: 'confirmEmail' },
